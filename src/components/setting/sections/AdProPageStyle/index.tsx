...
import IAdProPageStyle from './interface';

const AdProPageStyle = memo((props: IAdProPageStyle) => {
  return (
    <>
      <div>
        ...
        <OverlayTrigger
          ...
          overlay={
            <Tooltip>
              Wrap your content layout and select Full Width or Boxed styles.{" "}
            </Tooltip>
          }
        >
          <span>
      ...
      <div className="d-grid gap-3 grid-cols-2 mb-4">
        <RadioBtn
          ...
          defaultChecked={props.pageLayout}
          value="container"
        >
          Boxed
        </RadioBtn>
