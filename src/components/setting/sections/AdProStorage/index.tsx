...
import IAdProStorage from './interface'

const AdProStorage = memo((props: IAdProStorage) => {
    return (
        <>
            <div>
            ...
            <div className="d-grid gap-3 grid-cols-3 mb-4">
                <RadioBtn name="saveLocal" id="save-localstorage" labelClassName="d-block" defaultChecked={props.saveLocal} value="localStorage" >
                    Local
                </RadioBtn>
                <RadioBtn name="saveLocal" id="save-sessionstorage" labelClassName="d-block" defaultChecked={props.saveLocal} value="sessionStorage" >
                    Session
                </RadioBtn>
                <RadioBtn name="saveLocal" id="save-none" labelClassName="d-block" defaultChecked={props.saveLocal} value="none" >
                    None
                </RadioBtn>
            </div>
        </>
