...
import IBannerStyle from './interface'

const BannerStyle = memo((props: IBannerStyle) => {
    return (
        <>
            <div>
                <h6 className="mt-4 mb-3">Banner Style</h6>
                <div className="d-grid gap-3 grid-cols-3 mb-4">
                <RadioBtn name="header_banner" imgComponent={true} label="Color" className="text-center" labelClassName="p-0 d-block overflow-hidden" id="header-banner-color" defaultChecked={props.headerBanner} value="navs-bg-color" >
                ...
                <RadioBtn name="header_banner" imgComponent={true} label="Image" className="text-center" labelClassName="p-0 d-block overflow-hidden" id="header-banner-default" defaultChecked={props.headerBanner} value="default" >
                ...
                <RadioBtn name="header_banner" imgComponent={true} label="Hide" className="text-center" labelClassName="p-0 d-block overflow-hidden" id="hide-banner" defaultChecked={props.headerBanner} value="hide" >
                    ...
                    <small className="badge bg-danger position-absolute top-1 end-0 m-2">Tip</small>
                </RadioBtn>
                </div>
            </div>
        </>
